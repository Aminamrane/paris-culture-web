export var CATEGORIES = {
  ...
  street:      { label: 'Street art',                 color: '#F39C12', icon: 'color-palette-outline' },
  litterature: { label: 'Litterature & rencontres',   color: '#8E44AD', icon: 'book-outline' },
  immersif:    { label: 'Experiences immersives',     color: '#E91E63', icon: 'glasses-outline' },
};
